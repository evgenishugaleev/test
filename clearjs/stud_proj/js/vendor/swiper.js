  ...
  var B = {
    ...
    updateSlidesClasses: function () {
      ...
      if (r)
        ...
        n ? ((o = t.filter((e) => e.column === i)[0]), (c = t.filter((e) => e.column === i + 1)[0]), (d = t.filter((e) => e.column === i - 1)[0])) : (o = t[i]);
      (o &&
        (n ||
          ((c = (function (e, t) {
            const s = [];
  ...
  const ge = [
      ...
      const E = () => {
        ...
        x = (e) => {
          ...
          const r = (() => {
            let e;
            if (
              ((e = i.virtual && i.params.virtual.enabled ? i.slides.filter((e) => e.classList.contains('swiper-slide-active'))[0] : i.slides[i.activeIndex]),
              !e)
            )
              return;
    ...
    function (e) {
      ...
      const o = () => {
        ...
        return (
          'string' == typeof e && e.indexOf('%') >= 0 ? (e = (parseFloat(e.replace('%', '')) / 100) * r.size) : 'string' == typeof e && (e = parseFloat(e)),
          e
        );
      };
      (l('init', () => {
